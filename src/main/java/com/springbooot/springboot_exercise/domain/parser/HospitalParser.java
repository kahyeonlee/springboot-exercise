...
public class HospitalParser implements Parser<Hospital> {
    ...
    public Hospital parse(String str) {
        ...
        hospital.setLicenseDate(LocalDateTime.of(year, month, day, 0, 0, 0));hospital.setLicenseDate(LocalDateTime.of(year, month, day, 0, 0, 0));

        hospital.setBusinessStatus(String.valueOf(Integer.parseInt(row[7])));
